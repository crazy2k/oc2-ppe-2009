...
protcseg:	
    ...
    7c44:	e8 dd 00 00 00       	call   7d26 <cmain>
...
cmain(void)
{
    ...
    7d46:	45 4c 46 
    7d49:	75 3e                	jne    7d89 <cmain+0x63>
		goto bad;
    ...
    7d63:	eb 14                	jmp    7d79 <cmain+0x53>
	for (; ph < eph; ph++)
...
outw(int port, uint16_t data)
{
    ...
    7d9c:	eb fe                	jmp    7d9c <cmain+0x76>
